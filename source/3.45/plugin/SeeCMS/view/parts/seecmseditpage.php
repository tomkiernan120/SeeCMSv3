...
<div class="column">
				<div class="section">
					...
					<div class="sg_input">
						<p>Page title</p>
						<p><?php $f->text( array( 'name' => 'title', 'value' => htmlentities( $page->title ) ) ); ?></p>
					</div>
					<div class="sg_input">
						<p>HTML title</p>
						<p><?php $f->text( array( 'name' => 'htmltitle', 'value' => htmlentities( $page->htmltitle ), 'class' => 'count' ) ); ?> <span><span id="count">0</span> chars</span></p>
					</div>
				</div>
				<div class="section">
...
<div class="adf">
  <h3>Clone</h3>
  <div class="close">
    <a href="#" id="seecmsclonelink">
    <?php if( $data['cloneDetails'] ) { echo "Currently cloned from: {$data['cloneDetails']['name']}"; } else { echo 'Select a page'; } ?>
    </a>
    <br />
    <a id="seecmsremoveclone" href="#">
    <?php if( $data['cloneDetails'] ) { echo "Remove cloning"; } ?>
    </a>
    <?php $f->hidden( array( 'name' => 'clone', 'id' => 'clone', 'value' => $page->clone ) ); ?>
  </div>
</div>
...
?>
	...
	<div class="col2">
		...
		<div class="editpage">
			<a class="editpage" href="<?php echo (( $siteName && $siteName != $_SERVER['HTTP_HOST'] ) ? '/'.$page->site->route : (( $route->route != '/' ) ? '/' : '' ) ).$route->route; ?>?preview=1">Preview/edit page</a>
		</div>
    <div class="editpage">
      <a class="editpage openpage" target="_blank" href="<?php echo (( $route->route != '/' ) ? '/' : '' ).$route->route; ?>">Open live page</a>
    </div>
		<div class="support">
			<h2>Support</h2>
...
<div class="selectseecmsclonelink" id="selectseecmsclonelink" title="Select page" style="display: none;">
<?php echo $data['cloneLinkSelector']; ?>
</div>
<div class="clear"></div>