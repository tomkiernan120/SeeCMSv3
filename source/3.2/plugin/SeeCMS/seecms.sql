...
CREATE TABLE IF NOT EXISTS `route` (
  ...
  `objectid` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `Finder` (`primaryroute`,`objecttype`,`objectid`) COMMENT 'To speed up nav generation'
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
